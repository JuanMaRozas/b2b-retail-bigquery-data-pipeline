...
TARGET_TABLE = "stock"
LOCATION = "US"
UPLOAD_LOG = "upload_log_stock.txt"
# ----------------------

# 🆕 MANUAL LOAD DATE
MANUAL_LOAD_DATE = "2025-04-26"  # <<<< YOU set the upload date manually here
# ----------------------
...
new_files = [
    ...
    if f.startswith("stock_") and f.endswith(".csv") and f not in uploaded_files
]
...
if not new_files:
    ...
    for filename in new_files:
        ...
        try:
            ...
            # --- 🆕 Set load_date manually ---
            df["load_date"] = pd.to_datetime(MANUAL_LOAD_DATE).date()
            # ---------------------------------
        ...
        # 💡 Expected columns
        expected_columns = [
            "COD_CENCOSUD", "COD_PROVEEDOR", "DESCRIPCION_PRODUCTO", "MARCA",
            "SECCION", "RUBRO", "SUBRUBRO", "GRUPO", "COD_SURTIDO", "DESCRIPCION_SURTIDO",
            "COD_LOCAL", "TIPO_LOCAL", "DESCRIPCION_LOCAL", "FORMATO", "ZONA",
            "REGION", "CIUDAD", "DIVISION", "STOCK_Un", "OC_PENDIENTES",
            "TRASPASOS_CD", "QUIEBRE", "INSTOCK", "CATALOGADO", "HABILITADO",
            "VTA_ULT_12SEM", "VTA_ULT_4SEM", "VTA_ULT_SEM"
        ]
        ...
        schema = [
            ...
            bigquery.SchemaField("COD_SURTIDO", "STRING", mode="NULLABLE"),
            bigquery.SchemaField("DESCRIPCION_SURTIDO", "STRING", mode="NULLABLE"),
            ...
            bigquery.SchemaField("STOCK_Un", "FLOAT", mode="REQUIRED"),
            bigquery.SchemaField("OC_PENDIENTES", "FLOAT", mode="REQUIRED"),
            bigquery.SchemaField("TRASPASOS_CD", "FLOAT", mode="REQUIRED"),
            bigquery.SchemaField("QUIEBRE", "INTEGER", mode="REQUIRED"),
            bigquery.SchemaField("INSTOCK", "INTEGER", mode="REQUIRED"),
            bigquery.SchemaField("CATALOGADO", "INTEGER", mode="NULLABLE"),
            bigquery.SchemaField("HABILITADO", "INTEGER", mode="NULLABLE"),
            bigquery.SchemaField("VTA_ULT_12SEM", "FLOAT", mode="REQUIRED"),
            bigquery.SchemaField("VTA_ULT_4SEM", "FLOAT", mode="REQUIRED"),
            bigquery.SchemaField("VTA_ULT_SEM", "FLOAT", mode="REQUIRED"),
        ]
